...
*
*				Based on app-stl-viewer/app.js
*
***********************************************************/
...
//
// Need to change app secret HERE
//
app.use(session({
...
//
// Express Development error handler - will print stacktrace
//
...
//
// Expresss Production error handler - no stacktraces
//
app.use(function(err, req, res, next) {
    console.log('****** Error ' + err.status, err.message);
